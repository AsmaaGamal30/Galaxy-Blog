...
class PostController extends Controller
{
    ...
    public function home(): View
    {
        ...
        //if user authorized show recommended posts based on  user upvotes
        ...
        if ($user) {
            ...
            AND upvote_downvotes.user_id = ?) as t";
        ...
        //if user mot authorized show popular posts based on views
